  ...
  void loop() {
    ...
    // --- PRIORITAS CASE 10 Marble 2 turn right ---
    if (!passedCase10 && s1 == 0 && s2 == 0 && s3 == 1 && s4 == 1 && s5 == 1 && passedCase9 && !sensorBeforeActive) {
    Serial.println("turn right marble 2");
    ...
    // --- PRIORITAS CASE 13 Marble 3 turn left ---
    if (!passedCase13 && s1 == 1 && s2 == 1 && s3 == 1 && s4 == 0 && s5 == 0 && passedCase12 && !sensorBeforeActive) {
      Serial.println("turn left marble 3");
      sensorBeforeActive = true;
      flag = true;
        digitalWrite(MOTOR_A_DIR, 1);
        digitalWrite(MOTOR_B_DIR, 1);
    ...
    // --- PRIORITAS CASE 16 Marble 4 turn right ---
    if (!passedCase16 &&s1 == 0 && s2 == 0 && s3 == 1 && s4 == 1 && s5 == 1 && passedCase15 && !sensorBeforeActive) {
    Serial.println("turn right marble 4");
    sensorBeforeActive = true;
    flag = true;
    ...
    if (s1 == 1 && s2 == 1 && s3 == 1 && s4 == 1 && s5 == 1) {
      ...
      switch (junction) {
        ...
        case 2:  // turn left
          ...
          delay(250);
          break;
        case 3: //take tree, bacward, turn left
          ...
          delay(200);
          break;
        case 5:  //put a tree, backward, and turn left
          digitalWrite(MOTOR_A_DIR, 1);
          digitalWrite(MOTOR_B_DIR, 1);
          analogWrite(MOTOR_A_SPEED, 0);  
          analogWrite(MOTOR_B_SPEED, 0);  
        ...
        case 11: //take a marbel 2
          ...
          smoothMove(myServo1, 110, 28, 5); 
          delay(500);
          smoothMove(myServo2, 170, 110, 5);   
          delay(500);
          myServo1.write(120);
          delay(500);
    ...
    } else if (s2 == 1 && s3 == 1 && s4 == 1 && s5 == 1 && (!passedCase4 || !passedCase6)) {//case turn right
      if (!sensorBeforeActive) {        
        junction++;
        sensorBeforeActive = true;
        Serial.print("junction: ");
      ...
      switch (junction) {
        case 4:  //turn right before put a tree
          digitalWrite(MOTOR_A_DIR, 1);
          digitalWrite(MOTOR_B_DIR, 1);
          analogWrite(MOTOR_A_SPEED, 250);
          analogWrite(MOTOR_B_SPEED, 222);
          ...
          passedCase4 = true;
          break;
        case 6: //turn right in roundabout
          digitalWrite(MOTOR_A_DIR, 1);
          digitalWrite(MOTOR_B_DIR, 1);
          analogWrite(MOTOR_A_SPEED, 250);
          analogWrite(MOTOR_B_SPEED, 222);
    ...
    }  else if (s3 == 1 && s4 == 1 && s5 == 0 && passedCase6 && !passedCase7) { //case turn right
      if (!sensorBeforeActive) {        
        junction++;
        sensorBeforeActive = true;
        Serial.print("junction: ");
      ...
      switch (junction) {
        case 7:  //turn right after roundabout
          digitalWrite(MOTOR_A_DIR, 1);
          digitalWrite(MOTOR_B_DIR, 1);
          analogWrite(MOTOR_A_SPEED, 250);
          analogWrite(MOTOR_B_SPEED, 222);
